function selection(element, dishType) {

    let choice = document.querySelector(`.${dishType}.green-border`);
    let checking = document.querySelector(`.${dishType} .check.green-icon`);
    ...
    let checkIcon = document.querySelector(`.${dishType}.green-border .check`);
